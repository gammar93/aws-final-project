...
DATABASES = {
    'default': {
        ...
        'HOST': 'fprds.cdmc8scig7p8.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'fpbucketgamer' # please enter your s3 bucket name
